...
export class AuthenticationService {
    public token: string;
    public registrationServerUrl:string = 'http://localhost:8080/service-webapp/api/SignUp';
    public loginServerUrl:string = 'http://localhost:8080/service-webapp/api/LogIn';
